...
cl.send(xmpp.protocol.Message("arjonatorres79@gmail.com","Corriente 220V restablecida", typ='chat'))
cl.send(xmpp.protocol.Message("robdp79@gmail.com","Corriente 220V restablecida", typ='chat'))
#cl.send(xmpp.protocol.Message("arjonabarrones@gmail.com","Corriente 220V restablecida", typ='chat'))
cl.disconnect()
time.sleep(0.05)
...
enviarmailjose("Corriente 220V restablecida")
enviarmailro("Corriente 220V restablecida")
