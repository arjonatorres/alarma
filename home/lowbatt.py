...
cl.send(xmpp.protocol.Message("arjonatorres79@gmail.com","Bateria baja", typ='chat'))
#cl.send(xmpp.protocol.Message("robdp79@gmail.com","Bateria baja", typ='chat'))
cl.disconnect()
time.sleep(0.05)
...
enviarmailjose("Bateria baja")
#enviarmailro("Bateria baja")
